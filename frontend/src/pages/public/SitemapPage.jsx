  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 bg-white text-[#1A1A1A]">
        <h1 className="text-3xl md:text-4xl font-display font-extrabold tracking-tight mb-8">Sitemap</h1>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-sm font-bold">
          <div>
            <h2 className="text-[#7C5CFF] text-xs font-extrabold tracking-widest uppercase mb-4">Core Pages</h2>
          ...
          <div>
            <h2 className="text-[#7C5CFF] text-xs font-extrabold tracking-widest uppercase mb-4">Legal</h2>
            <div className="flex flex-col gap-2">
