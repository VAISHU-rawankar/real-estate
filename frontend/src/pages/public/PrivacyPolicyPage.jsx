  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 bg-white text-[#1A1A1A]">
        <h1 className="text-3xl md:text-4xl font-display font-semibold tracking-tight mb-6">Privacy Policy</h1>
        ...
        <div className="space-y-6 text-sm text-[#666666] leading-relaxed font-medium">
          ...
          <h2 className="text-xl font-display font-semibold text-[#1A1A1A] mt-8">1. Information We Collect</h2>
